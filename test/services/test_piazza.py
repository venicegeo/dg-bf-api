...
class CreateTriggerTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/trigger', m.request_history[0].url)
...
class DeployTest(unittest.TestCase):
    ...
    def test_calls_correct_urls(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/deployment', m.request_history[0].url)
        self.assertEqual('https://test-piazza-host.localdomain/job/test-job-id', m.request_history[1].url)
    ...
    def test_honors_polling_interval(self, m: Mocker):
        ...
        with unittest.mock.patch('time.sleep') as stub:
            piazza.deploy(data_id='test-data-id', poll_interval=-12345, max_poll_attempts=2)
    ...
    def test_returns_layer_id(self, m: Mocker):
        ...
        layer_id = piazza.deploy(data_id='test-data-id', poll_interval=0, max_poll_attempts=2)
...
class ExecuteTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/job', m.request_history[0].url)
...
class GetFileTest(unittest.TestCase):
    ...
    def test_calls_correct_urls(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/file/test-data-id', m.request_history[0].url)
...
class GetStatusTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/job/test-job-id', m.request_history[0].url)
...
class GetServiceTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/service/test-id', m.request_history[0].url)
...
class GetServicesTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/service?', m.request_history[0].url[:45])
        self.assertSetEqual({
            'perPage=100',
...
class GetTriggersTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/trigger/query', m.request_history[0].url)
...
class RegisterServiceTest(unittest.TestCase):
    ...
    def test_calls_correct_url(self, m: Mocker):
        ...
        self.assertEqual('https://test-piazza-host.localdomain/service', m.request_history[0].url)
